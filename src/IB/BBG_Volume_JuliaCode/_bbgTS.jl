...
function toXLDate(d::Date)
    return Int(d - Date(1899,12,30))
end
...
function arrayAusgabe(n)

  A = rand(Float64, Int(n), Int(n))
  return A
...
#
#
# instContracts = Dict([("NBP", basicInstrument("FNA Comdty", "TRADE")),
#                         ("Brent", basicInstrument("COA Comdty", "TRADE")),
#                         ("Bund", basicInstrument("RXA Comdty", "TRADE")),
#                         ("Sugar", basicInstrument("QWA Comdty", "TRADE")),
#                         ("Cocoa", basicInstrument("QCA Comdty", "TRADE"))])
